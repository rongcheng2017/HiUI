package com.rongcheng.hi.ui.app.banner
...
import com.rongcheng.hi.ui.banner.core.HiBannerAdapter
import com.rongcheng.hi.ui.banner.core.HiBannerMo
import com.rongcheng.hi.ui.banner.core.IBindAdapter
...
//        mHiBanner!!.setHiIndicator(hiIndicator)
        ...
        mHiBanner.setBindAdapter(object : IBindAdapter<FrameLayout> {
            override fun onBind(
